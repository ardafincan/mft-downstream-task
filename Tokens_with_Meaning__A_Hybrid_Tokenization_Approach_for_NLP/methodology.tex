...
\textbf{Tokenization Efficiency.} We benchmark tokenization speed and token density on 1,000 Turkish text samples from our corpus. Table~\ref{tab:tokenization_efficiency} compares TurkishTokenizer against three Turkish-trained baseline tokenizers under matched vocabulary size (32,768).
